...
//print_r($_POST['titulo']);
                ...
                //'estacionamento'=> $this->parking_model->getDatas( $_POST['titulo'])
                $data = ['estacionamento'=>$this->parking_model->dataparking($_POST['titulo']),'titulo'=>  $_POST['titulo'],'info'=>  $this->parking_model->dataparking( $_POST['titulo']),'vagas'=>$_POST['datas_banco'],'id_estacionamento'];
                $this->load->view('templates/header');
                $this->load->view('site/integra',$data);
...
//botei aqui
  				$this->load->model("user_model");
                                $this->load->model("parking_model");
			$creditoAtual = intval($this->user_model->retornaCreditos($_POST['id_usuario']));
if(sizeof($array) > $creditoAtual){
 $data = ['estacionamento'=>$this->parking_model->dataparking($_POST['titulo']),'titulo'=>  $_POST['titulo'],'info'=>  $this->parking_model->dataparking( $_POST['titulo']),'vagas'=>$_POST['datas_banco'],'mais_vagas_doq_credito'=>'SELECIONE MENOS DATAS, VOCE ESTA POBRE'];
                            $this->load->view('templates/header');
                            $this->load->view('site/integra',$data);
...
return;
                        ...
                        if($creditoAtual <= 0){
                            $data = ['estacionamento'=>$this->parking_model->dataparking($_POST['titulo']),'titulo'=>  $_POST['titulo'],'info'=>  $this->parking_model->dataparking( $_POST['titulo']),'vagas'=>$_POST['datas_banco'],'acabou_credito'=>'SALDO INSUFICIENTE'];
                            $this->load->view('templates/header');
                            $this->load->view('site/integra',$data);
                            return;
                        }
              ...
              // $this->load->view('dashboard/selecao_multipla',$data);
                ...
                $data = ['estacionamento'=>$this->parking_model->dataparking($_POST['titulo']),'titulo'=>  $_POST['titulo'],'info'=>  $this->parking_model->dataparking( $_POST['titulo']),'vagas'=>$_POST['datas_banco'],'id_estacionamento','reserva_realizada'=>'SUA RESERVA FOI REALIZADA'];
                $this->load->view('templates/header');
                $this->load->view('site/integra',$data);
$_SESSION['reserva_realizada'] = "RESERVA REALIZADA";
